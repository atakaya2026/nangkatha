...
(function () {
  ...
  var INTRO_SLIDES = [
    { image: './images/fingers.png', text: 'ဒါက လက်ချောင်းတွေရဲ့ မှန်ကန်တဲ့ နေရာ ဖြစ်ပါတယ်။\nအခုကနေ အဆုံးထိ ဒီနေရာအတိုင်း ထားပါ!' },
    { image: './images/fingers2.png', text: 'လက်ချောင်းတစ်ချောင်းစီက ဒေါင်လိုက် ကော်လံတစ်ခုကိုသာ တာဝန်ယူပါတယ်။\nအခု လက်ချောင်းတစ်ချောင်းစီကို အပေါ်အောက် လုံလောက်စွာ လှုပ်ကြည့်ပါ။' }
  ];
  ...
  var STAGES = [
    {
      ...
      hideDelayMs: 0,
      title: 'အဆင့် ၁',
      text: 'ပထမ လက်ညှိုး၊ လက်ခလယ်၊ လက်သူကြွယ် ၃ ချောင်းနဲ့ပဲ မှဲ့ကို ဖမ်းပါ။\nနေရာအလိုက် မှန်ကန်တဲ့ လက်ချောင်းကို သုံးပါ။'
    },
    {
      ...
      passThreshold: 0.8,
      title: 'အဆင့် ၂',
      text: 'လက်သန်းနဲ့လည်း မှဲ့ကို ဖမ်းပါ။\nအခုကနေ မှဲ့ ပြန်ပုန်းမသွားခင် ဖမ်းရပါမယ်!'
    },
    {
      columns: [4, 5, 6, 7],
      moleCount: 40,
      ...
      text: 'တော်တော်လေး ရောက်လာပါပြီ။\nအလယ်က ကော်လံ ၂ ခုကို လက်ညှိုးကို အတွင်းဘက် ဆန့်ပြီး ရိုက်ပါတယ်။\nလက်ချောင်း ဆန့်ပြီးရင် မူလနေရာကို အမြဲ ပြန်လာပါ။'
    },
    {
      ...
      passThreshold: 0.8,
      title: 'အဆင့် ၄',
      text: 'ကဲ၊ အခု နောက်ဆုံးအဆင့်ပါ။\nမှဲ့တွေ နေရာအားလုံးကနေ ထွက်လာနေပါပြီ။\nလက်ချောင်းနေရာ မှန်အောင်ထားပြီး စလိုက်ပါ!'
    }
  ];
  ...
  function showFail(stage, stageIdx) {
    ...
    renderSlide({
      title: stage.title + ' — ထပ်ကြိုးစားပါ',
      text: 'အင်း! အောင်ဖို့ မှဲ့ အနည်းဆုံး ' + pct + '% ဖမ်းရပါမယ်။\nဒီအဆင့်ကို ထပ်ကြိုးစားကြည့်ရအောင်!',
      image: null
    });
  ...
  function goToDemo() {
    window.location.href = 'tutorial_pc.html';
  }
